...
var finger = $('<div class="tutorial">').hide();

document.body.appendChild(good[0]);
document.body.appendChild(nogood[0]);
document.body.appendChild(finger[0]);
...
function Tutorial(){
  ...
  Tutorial.finger = function(){
    if(P._go){
      finger.hide(200);
      setTimeout(function(){finger.remove();},200);
    } else {
      finger.show(200);
    }
  }
